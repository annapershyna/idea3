...
const cards = [
  { title: { en: "Web Development", uk: "Веб-розробка" }, description: { en: "Scalable web platforms and internal tools built for performance, security, and long-term maintainability.", uk: "Масштабовані вебплатформи та внутрішні інструменти з фокусом на продуктивність, безпеку та довгострокову підтримуваність." }, icon: Code2, href: "/services/custom-software-development" },
  { title: { en: "Mobile Apps", uk: "Мобільні застосунки" }, description: { en: "Native-like mobile experiences for iOS and Android with stable release workflows and product-grade UX.", uk: "Нативний mobile-досвід для iOS та Android зі стабільними релізними процесами та продуктовим UX." }, icon: Smartphone, href: "/services/mobile-app-development" },
