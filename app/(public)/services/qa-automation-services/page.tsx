...
const copy = {
  en: {
    ...
    faqs: [
      ...
      ["How much does QA automation cost?", "Core CI/CD integration and e2e coverage starts at $1,500+. Comprehensive multi-layer test automation ranges from $2,000+. Ongoing retainers run $1,000+/month."],
  ...
  uk: {
    ...
    faqs: [
      ...
      ["Скільки коштує автоматизація QA?", "Базова інтеграція CI/CD і покриття наскрізних сценаріїв стартує від $1,500+. Комплексна багаторівнева автоматизація тестування — від $2,000+. Постійний супровід — від $1,000+ на місяць."],
